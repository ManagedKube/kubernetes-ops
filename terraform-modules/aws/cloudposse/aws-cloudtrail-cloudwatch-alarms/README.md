...
| <a name="input_cloudtrail_event_selector"></a> [cloudtrail\_event\_selector](#input\_cloudtrail\_event\_selector) | This enables the cloudtrail even selector to track all S3 API calls: https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudtrail. | `list(any)` | <pre>[<br>  {<br>    "data_resource": {<br>      "type": "AWS::S3::Object",<br>      "values": [<br>        "arn:aws:s3"<br>      ]<br>    },<br>    "include_management_events": true,<br>    "read_write_type": "All"<br>  }<br>]</pre> | no |
