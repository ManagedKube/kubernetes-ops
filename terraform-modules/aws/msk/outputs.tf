...
output "bootstrap_brokers_tls" {
  ...
  value       = module.bootstrap_brokers_tls
}
...
output "bootstrap_brokers_scram" {
  ...
  value       = module.bootstrap_brokers_scram
}
...
output "bootstrap_brokers_iam" {
  ...
  value       = module.bootstrap_brokers_iam
}

output "all_brokers" {
  description = "A list of all brokers"
  value       = module.all_brokers
}

output "current_version" {
  description = "Current version of the MSK Cluster used for updates"
  value       = module.current_version
}

output "config_arn" {
  description = "Amazon Resource Name (ARN) of the configuration"
  value       = module.config_arn
}

output "latest_revision" {
  description = "Latest revision of the configuration"
  value       = module.latest_revision
}
...
output "security_group_id" {
  ...
  value       = module.security_group_id
}
