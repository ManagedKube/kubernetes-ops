...
| <a name="input_security_group_ids"></a> [security\_group\_ids](#input\_security\_group\_ids) | Set of Security Group identifiers. | `list(string)` | n/a | yes |
...
| <a name="input_user_password"></a> [user\_password](#input\_user\_password) | The default password for all Aric MongoDB users. | `string` | n/a | yes |
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | VPC id | `string` | n/a | yes |
| <a name="input_x509_admin_username"></a> [x509\_admin\_username](#input\_x509\_admin\_username) | The admin username that requires a x509 MongoDB managed cert | `string` | n/a | yes |
| <a name="input_x509_months_until_expiration"></a> [x509\_months\_until\_expiration](#input\_x509\_months\_until\_expiration) | The number of months the x509 user certificate will remain active | `number` | n/a | yes |
| <a name="input_x509_type"></a> [x509\_type](#input\_x509\_type) | The type of x509 certificate and who will be managing it | `string` | n/a | yes |
