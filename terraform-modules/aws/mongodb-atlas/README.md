...
| <a name="input_egress_rule"></a> [egress\_rule](#input\_egress\_rule) | A list of ingress rules | `list` | <pre>[<br>  {<br>    "cidr_blocks": [<br>      "0.0.0.0/0"<br>    ],<br>    "description": "All",<br>    "from_port": 0,<br>    "ipv6_cidr_blocks": [<br>      "::/0"<br>    ],<br>    "protocol": "-1",<br>    "to_port": 0<br>  }<br>]</pre> | no |
...
| <a name="input_ingress_rule"></a> [ingress\_rule](#input\_ingress\_rule) | A list of ingress rules | `list` | <pre>[<br>  {<br>    "cidr_blocks": [<br>      "10.0.0.0/8",<br>      "172.16.0.0/12",<br>      "192.168.0.0/16"<br>    ],<br>    "description": "All ports from internal addresses",<br>    "from_port": 0,<br>    "ipv6_cidr_blocks": [],<br>    "protocol": "tcp",<br>    "to_port": 0<br>  }<br>]</pre> | no |
